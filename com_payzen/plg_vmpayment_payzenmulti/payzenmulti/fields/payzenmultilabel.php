 ...
 */
class JFormFieldPayzenMultiLabel extends JFormField
{
    ...
    function getInput()
    {
        if ($this->fieldname == 'documentation') {
            return '<a style="color: red;" target="_blank" href="' . JURI::root() . $this->value . '">' . JText::_('VMPAYMENT_PAYZENMULTI_DOC_TEXT') . '</a>';
        }
