...
class plgVMPaymentPayzenMulti extends vmPSPlugin
{
    ...
    function getTableSQLFields()
    {
        ...
        $SQLfields = array(
            ...
            'payzenmulti_response_trans_id'         => 'char(6)',
    ...
    function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $request->set('contrib', 'VirtueMart3.x_2.1.0/' . JVERSION . '_' . vmVersion::$RELEASE . '/' . PHP_VERSION);
        ...
        $form .= '<br />';
        $form .= '<input type="image" name="submit" src="' . JURI::base(true) . '/images/stories/virtuemart/payment/' . 'payzenmulti.png'.'" alt="' . JText::_('VMPAYMENT_' . $this->_name . '_BTN_ALT') . '" title="' . JText::_('VMPAYMENT_' . $this->_name . '_BTN_TITLE') . '"/>';
    ...
    function plgVmOnShowOrderBEPayment($virtuemart_order_id, $payment_method_id)
    {
        ...
        $html .= $this->getHtmlRowBE($this->_name . '_CC_TYPE', $payment_data->$response_payment_mean ? $payment_data->$response_payment_mean : '-');
        $html .= '</table>' . "\n";
